...
#	DEEP
	[0.0003, 12, 100, 200, 200, '2.0,1.5,1.0,0.5', '2.0,1.5,1.0,0.5', "learn_sq", False, '30, 30', 'affected_side'],
...
for config in configs:
	...
	FLAGS.log_dir = r'D:\Experiments\logs\CIFAR_' + config[10] + '\\cnn\Shallow\\' \
	...
	FLAGS.checkpoint_dir = r'D:\Experiments\checkpoints\CIFAR_' + config[10] + '\\cnn\Shallow\\' \
						   + str(FLAGS.init_kernel) + 'x' + str(FLAGS.comp_kernel) + '_' \
						   + str(FLAGS.learning_rate) + '_' \
						   + str(FLAGS.growth_rate) + '_' \
						   + str(FLAGS.depth) + '_' \
	...
	FLAGS.stat_dir = r'D:\Experiments\stats\CIFAR_' + config[10] + '\\cnn\Shallow\\' \
					 + str(FLAGS.init_kernel) + 'x' + str(FLAGS.comp_kernel) + '_' \
					 + str(FLAGS.learning_rate) + '_' \
					 + str(FLAGS.growth_rate) + '_' \
					 + str(FLAGS.depth) + '_' \
