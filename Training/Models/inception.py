...
class Inception(object):
	...
	def __init__(self,
		...
		self.scope					= self.inception_v3_arg_scope()
			...
			with arg_scope(
				...
				with variable_scope.variable_scope(end_point):
					...
					with variable_scope.variable_scope('Branch_3'):
						...
						branch_3 = layers.conv2d(branch_3, depth(32), [1, 1], scope='Conv2d_0b_1x1')
			...
			with arg_scope(
				...
				with variable_scope.variable_scope('Logits'):
					...
					net = layers_lib.dropout(
							net, keep_prob=self.dropout_keep_prob, scope='Dropout_1b')
